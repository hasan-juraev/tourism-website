    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <form class="form-auth" action="includes/login.inc.php" method="post">
                ...
                <h6 class="h3 my-5 font-weight-normal text-muted text-center">Login to your Account</h6>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="username" name="username" class="form-control my-3" placeholder="Username" required autofocus>
