...
if (!defined('APP_NAME'))                       define('APP_NAME', 'Korea Tourism');
if (!defined('APP_ORGANIZATION'))               define('APP_ORGANIZATION', 'Haksenguz');
...
if (!defined('DB_DATABASE'))                    define('DB_DATABASE', 'halaltour_kr');
...
if (!defined('MAIL_USERNAME'))                  define('MAIL_USERNAME', 'hbycleverboy777@gmail.com');
if (!defined('MAIL_PASSWORD'))                  define('MAIL_PASSWORD', 'acnuqxrguuwywvmy');
